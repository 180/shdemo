...
@Component
@Transactional
public class ServicingMangerHibernateImpl implements ServicingManager {
	...
	@Override
	public void updateXero(Xero x) {
		Xero x2 = (Xero) sessionFactory.getCurrentSession().get(Xero.class, x.getId());
		x2.setMake(x.getMake());
		x2.setModel(x.getModel());
		x2.setType(x.getType());
